 ...
 * @author: wulinfeng
 */
public class AmoKafkaProducerFactory<K, V> extends NormalKafkaProducerFactory<K, V> {

    public AmoKafkaProducerFactory(Map<String, Object> configs) {
        super(configs);
        initAmo();
    }

    public AmoKafkaProducerFactory(Map<String, Object> configs, Serializer<K> keySerializer, Serializer<V> valueSerializer) {
        super(configs, keySerializer, valueSerializer);
        initAmo();
    }

    public AmoKafkaProducerFactory(Map<String, Object> configs, Supplier<Serializer<K>> keySerializerSupplier, Supplier<Serializer<V>> valueSerializerSupplier) {
